...
from settings import INSTRUMENTED_DIR, WORKING_DIR
...
class ToolSpec(AbstractTool):
    def __init__(self):
        ...
        and researchers to customize, develop and test new test generators.(https://github.com/uds-se/droidmate).""", 'org.droidmate')
