...
boxplot( t(alls), names=snames, ylab="percentage (unique view)", horizontal=TRUE, las=1, cex.names=0.1, range=0,cex.axis=0.25,lwd=0.3,cex.lab=0.5, col=colors)
...
pdf("./src-d.pdf",width=2.5,height=3.0)
r=1
...
boxplot( t(alld), names=dnames, ylab="percentage (unique view)", horizontal=TRUE, las=1, cex.names=0.1, range=0,cex.axis=0.25,lwd=0.3,cex.lab=0.5, col=colors)
#boxplot( t(alld), xlab="percentage", horizontal=TRUE, las=1, cex.axis=.5, cex.names=.5)
...
pdf("./src-dins.pdf",width=2.5,height=3.0)
r=1
