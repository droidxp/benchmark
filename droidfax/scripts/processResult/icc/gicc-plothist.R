...
pdf("./gicc-databoth-hist.pdf")#,width=3.5,height=2.5)
dataextraboth <- cbind ( dataextra[,1],dataextrainter[,1], dataextra[,2],dataextrainter[,2], dataextra[,3],dataextrainter[,3] )
plot(dataextraboth[,1], col="gray30",ylab="percentage (instance view)", xlab="single-app / standard data only",type='h')
plot(dataextraboth[,2], col="gray30",ylab="percentage (instance view)", xlab="inter-app / standard data only",type='h')
plot(dataextraboth[,3],   col="gray30",ylab="percentage (instance view)", xlab="single-app / bundle only",type='h')
plot(dataextraboth[,4],   col="gray30",ylab="percentage (instance view)", xlab="inter-app / bundle only",type='h')
plot(dataextraboth[,5],   col="gray30",ylab="percentage (instance view)", xlab="single-app / both data",type='h')
plot(dataextraboth[,6],   col="gray30",ylab="percentage (instance view)", xlab="inter-app / both data",type='h')

pdf("./gicc-iccboth-hist.pdf")#,width=3.5,height=2.5)
...
#}
plot(giccboth[,1],   col="gray30",ylab="percentage (instance view)", xlab="single-app / internal explicit ",type='h')
plot(giccboth[,2],   col="gray30",ylab="percentage (instance view)", xlab="inter-app / internal explicit ",type='h')
plot(giccboth[,3],   col="gray30",ylab="percentage (instance view)", xlab="single-app / internal implicit",type='h')
plot(giccboth[,4],   col="gray30",ylab="percentage (instance view)", xlab="inter-app / internal implicit",type='h')
plot(giccboth[,5],   col="gray30",ylab="percentage (instance view)", xlab="single-app / external explicit ",type='h')
plot(giccboth[,6],   col="gray30",ylab="percentage (instance view)", xlab="inter-app / external explicit ",type='h')
plot(giccboth[,7],   col="gray30",ylab="percentage (instance view)", xlab="single-app / external implicit",type='h')
plot(giccboth[,8],   col="gray30",ylab="percentage (instance view)", xlab="inter-app / external implicit",type='h')
