...
pdf("./deiccboth-hist.pdf")#,width=2.5,height=3.0)
deiccboth <- cbind ( deicc[,1],deinterICC[,1], deicc[,2],deinterICC[,2], deicc[,3],deinterICC[,3], deicc[,4],deinterICC[,4] )

plot(deiccboth[,1],   col="gray30",ylab="percentage (instance view)", xlab="single-app / internal explicit ",type='h')
plot(deiccboth[,2],   col="gray30",ylab="percentage (instance view)", xlab="inter-app / internal explicit ",type='h')
plot(deiccboth[,3],   col="gray30",ylab="percentage (instance view)", xlab="single-app / internal implicit",type='h')
plot(deiccboth[,4],   col="gray30",ylab="percentage (instance view)", xlab="inter-app / internal implicit",type='h')
plot(deiccboth[,5],   col="gray30",ylab="percentage (instance view)", xlab="single-app / external explicit ",type='h')
plot(deiccboth[,6],   col="gray30",ylab="percentage (instance view)", xlab="inter-app / external explicit ",type='h')
plot(deiccboth[,7],   col="gray30",ylab="percentage (instance view)", xlab="single-app / external implicit",type='h')
plot(deiccboth[,8],   col="gray30",ylab="percentage (instance view)", xlab="inter-app / external implicit",type='h')
